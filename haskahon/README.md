...
- `data/haskahon.sqlite` — profile, archive, scripts and source metadata
...
The architecture and security boundaries are documented in `docs/architecture-haskahon.md`.
